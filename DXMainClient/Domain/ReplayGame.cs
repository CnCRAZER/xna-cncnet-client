...
namespace DTAClient.Domain
{
    ...
    public class ReplayGame
    {
        ...
        public uint GameMode { get; private set; } // Skirmish=5, LAN=3, Internet=4, Campaign=0
        ...
        /// </summary>
        public string ExtractSpawnIni() => spawnIniContent ?? string.Empty;

        /// <summary>
        /// Extracts spawnmap.ini content from the replay.
        /// </summary>
        public string ExtractSpawnMap() => spawnMapContent ?? string.Empty;
